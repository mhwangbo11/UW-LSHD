...
Among 40 available countires or areas, in this brief, 'Germany, Total population: Population size' data was imported.

```{r, echo = FALSE, message = F}
## loading libraries ##
library (plotly)  # Package for viz using plotly interactives
library (ggplot2) # Package for ggplot viz
library (pyramid) # Package for pyramid visual creation.
